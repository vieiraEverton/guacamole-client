 ...
 * single keyboard key.
 */
 angular.module('ivTools').directive('guacIvKey', [function guacKey() {
    ...
    return {
        ...
        scope: {
            ...
            /**
             * The image to disply in this button
             * 
             * @type String
             * @default empty
             */
        ...
        templateUrl: 'app/ivTools/templates/guacIvKey.html',
        controller: ['$scope', '$rootScope',
            ...
            $scope.showBtnImage = !!$scope.imageurl;
            $scope.showPressedBtnImage = !!$scope.pressedimageurl;
